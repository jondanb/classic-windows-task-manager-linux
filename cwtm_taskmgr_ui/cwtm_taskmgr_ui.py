...
class Ui_CWTM_TaskManagerMainWindow(QMainWindow):
    def setupUi(self, CWTM_TaskManagerMainWindow):
        ...
        self.tm_view_menu_cpuh_one_graph_all_cpus = QAction(CWTM_TaskManagerMainWindow)
        self.tm_view_menu_cpuh_one_graph_all_cpus.setObjectName(u"tm_view_menu_cpuh_one_graph_all_cpus")
        self.tm_view_menu_cpuh_one_graph_per_cpu = QAction(CWTM_TaskManagerMainWindow)
        self.tm_view_menu_cpuh_one_graph_per_cpu.setObjectName(u"tm_view_menu_cpuh_one_graph_per_cpu")
        ...
        self.tm_view_menu_menu_cpu_history.addAction(self.tm_view_menu_cpuh_one_graph_all_cpus)
        self.tm_view_menu_menu_cpu_history.addAction(self.tm_view_menu_cpuh_one_graph_per_cpu)
    ...
    def retranslateUi(self, CWTM_TaskManagerMainWindow):
        ...
        self.tm_view_menu_cpuh_one_graph_all_cpus.setText(QCoreApplication.translate("CWTM_TaskManagerMainWindow", u"One Graph, All CPUs", None))
        self.tm_view_menu_cpuh_one_graph_per_cpu.setText(QCoreApplication.translate("CWTM_TaskManagerMainWindow", u"One Graph, Per CPU", None))
